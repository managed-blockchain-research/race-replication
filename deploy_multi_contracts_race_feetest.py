#!/usr/bin/env python3
"""
Deploy N StateBloater contracts and update networkconfig_race_feetest.json.
...
print(f'\nAll {N} contracts deployed. Updating networkconfig_race_feetest.json...')

with open('networkconfig_race_feetest.json', 'r') as f:
    config = json.load(f)
...
with open('networkconfig_race_feetest.json', 'w') as f:
    json.dump(config, f, indent=2)

print(f'networkconfig_race_feetest.json updated with {N} contracts (SB0..SB{N-1})')
